...
function preload() { 
  ...
  b = loadImage("b.jpg") 
  b2 = loadImage("AdamInjuredFinal2.png") 
  homeScreen = loadImage("CROSSCOUNTRYSIMULATOR.jpg")
  Screen = loadImage("AdamHeadFinal.jpg")
  lakeMercedCourse = loadImage("LakerMercedBackground.png")
  lakeMercedCourseRed = loadImage("LakerMercedBackgroundred.png")
  trackCourse = loadImage("TrackFieldBackground.png")
  trackCourseRed = loadImage("TrackFieldBackgroundred.png")
  homeCourse = loadImage("ChampsCourseBackground.png")
  homeCourseRed = loadImage("ChampsCourseBackgroundred.png")
  vikingCourse = loadImage("VikingOpenerBackground.png")
  vikingCourseRed = loadImage("VikingOpenerBackgroundred.png")
  NCSCourse = loadImage("HaywardBackground.png")
  NCSCourseRed = loadImage("HaywardBackgroundred.png")
  statesCourse = loadImage("BCL1Background.png")
  statesCourseRed = loadImage("BCL1Backgroundred.png")
...
function startScreen(_callback){
	...
	textSize(20)
	text("Instructions:",50,height/2)
	textSize(12)
	text("This is a cross country Simulator.",40,height/2+30)
	text("It is June 10, you are a new runner starting the cross country season",40,height/2+50)
	text("You will go through each day of the season, doing the workouts and racing the races",40,height/2+70)
	textSize(16)
	text("Tips:",50,height/2+100)
	textSize(12)
	text("Don't do two workouts/races in a row",40,height/2+130)
	text("Do the coach-prescribed workouts from the real cross country team to get stat boosts",40,height/2+150)
	text("Be careful, rocks will randomly spawn fast at the start of races to simulate real starts",40,height/2+170)
